 ...
 */ (function (window, undefined) {
    ...
    S.setDimensions = function (height, width, maxHeight, maxWidth, topBottom, leftRight, padding, preserveAspect) {
        var originalHeight = height,
            originalWidth = width;
        var extraHeight = 2 * padding + 20 + topBottom;
        if (height + extraHeight > maxHeight) {
            height = maxHeight - extraHeight
        }
        var extraWidth = 2 * 20 + leftRight;
        ...
        S.dimensions = {
            ...
            innerHeight: height,
            innerWidth: width,
            top: Math.floor((maxHeight - (height + extraHeight)) / 2 + 20 ),
            left: Math.floor((maxWidth - (width + extraWidth)) / 2 + 20),
            oversized: oversized,
	        oversizedX: oversizedX
        };
        return S.dimensions
    };
    ...
    S.img.prototype = {
        append: function (body, dims) {
	        ...
	        if( S.options.handleOversize != "scroll" && !S.isWebKit )
    ...
    function adjustWidth(width, left, anim, callback) {
		...
		var _width = width;
	    if( S.options.handleOversize == "scroll" && !S.dimensions.oversizedX ) {
        ...
        animate(wrapper, "width", _width, duration, callback)
    }
    function setDimensions(height, width) {
        ...
        var bodyInner = get("sb-body-inner"),
            ...
            preserveAspect = (S.player && ( S.options.handleOversize != "drag" && S.options.handleOversize != "scroll" )  );
